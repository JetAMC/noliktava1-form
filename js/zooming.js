    ...
    var p = {
            init: function (t) {
                (this.el = document.createElement("div")),
                    ...
                    c(this.el, { position: "fixed", top: 0, left: 0, right: 0, bottom: 0, opacity: 0 }),
                    this.updateStyle(t.options),
                    l(this.el, "click", t.handler.clickOverlay.bind(t));
            },
            updateStyle: function (t) {
                c(this.el, { zIndex: t.zIndex, backgroundColor: t.bgColor, transition: "opacity\n        " + t.transitionDuration + "s\n        " + t.transitionTimingFunction });
            },
            insert: function () {
        ...
        v = {
            ...
            zoomIn: function () {
                ...
                (this.translate = this.calculateTranslate()),
                    ...
                    this.el.offsetWidth,
                    (this.styleClose = c(this.el, this.styleOpen, !0));
            },
            zoomOut: function () {
    ...
    return (function () {
        function e(t) {
            !(function (t, e) {
                ...
                (this.target = Object.create(v)),
                (this.overlay = Object.create(p)),
                (this.handler = Object.create(u)),
            ...
            y(e, [
                {
                    key: "listen",
                    value: function (t) {
                        if ("string" == typeof t) for (var e = document.querySelectorAll(t), i = e.length; i--; ) this.listen(e[i]);
                        ...
                        if (!this.shown && !this.lock) {
                            ...
                            if ("IMG" === n.tagName) {
                                ...
                                (this.shown = !0),
                                    ...
                                    this.overlay.insert(),
                                    this.overlay.fadeIn(),
                                    l(document, "scroll", this.handler.scroll),
                                    l(document, "keydown", this.handler.keydown),
                                    this.options.closeOnWindowResize && l(window, "resize", this.handler.resizeWindow);
                                return (
                                    l(n, "transitionend", function t() {
                    ...
                    value: function () {
                        ...
                        if (this.shown && !this.lock) {
                            ...
                            this.options.onBeforeClose(n),
                                ...
                                this.target.zoomOut(),
                                l(document, "scroll", this.handler.scroll, !1),
                                l(document, "keydown", this.handler.keydown, !1),
                                this.options.closeOnWindowResize && l(window, "resize", this.handler.resizeWindow, !1);
                            return (
                                l(n, "transitionend", function t() {
